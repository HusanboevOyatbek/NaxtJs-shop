...
const SinglePage = async ({
  ...
  return (
    ...
    <div className="">
            ...
            <div className="grid md:grid-cols-2 gap-14">
              ...
              <div className="space-y-7">
                ...
                <div className="flex gap-4">
                  ...
                  <button className="flex-1 bg-black text-white py-3 rounded-xl font-semibold hover:bg-neutral-800 transition">
                    Add to Cart
                  </button>
                </div>
      ...
      <section>
        <div className="container mx-auto bg-neutral-50 py-8">
          <h1 className="text-center text-[48px] text-black mb-[40px] font-bold">You might also like</h1>
          <div className="max-w-7xl mx-auto px-4">
            {/* Horizontal Scroll Container */}
            <div className="flex gap-[30px] overflow-x-auto scrollbar-hide pb-4">
              {/* Product Card 1 */}
